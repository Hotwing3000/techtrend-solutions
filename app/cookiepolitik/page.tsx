...
export default function CookiepolitikPage() {
  return (
    <LegalLayout
      title="Cookiepolitik"
      intro="Denne politik forklarer, hvilke cookies vi bruger på hotwing-dev.vercel.app, hvorfor vi bruger dem, og hvordan du selv styrer dit samtykke."
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-slate-100">
            <tr>
              ...
              <td className="px-4 py-3 align-top">hotwing-dev.vercel.app</td>
